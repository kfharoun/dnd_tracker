...
export default function CharacterList(props) {
  ...
  const handleDelete = async () => {
    try {
      await axios.delete(`http://localhost:3001/Character/${id}`)
      navigate('/Character')
    } catch (error) {
  ...
  return loading ? (
    ...
    <div className="CharacterPage">
      ...
      <div className="characterlists">
        <div className="char-list">
          ...
          <Link to="/Character" className="returncharacter">
            return to character list
          </Link>
          <a className="deleteButton" onClick={toggleDeleteModal}>
              Delete Character?
            </a>
        </div>
        <div className="char-list-two">
          ...
          <div className="stats">
            <p className="statinfo">Armor Class</p>
            <p>{character.armor_class}</p>
          </div>
          <div className="stats">
            <p className="statinfo">Hit Points</p>
            <p>{character.hit_points}</p>
          </div>
          <div className="stats">
            <p className="statinfo">Strength</p>
            <p>{character.strength}</p>
          </div>
          <div className="stats">
            <p className="statinfo">Dexterity</p>
            <p>{character.dexterity}</p>
          </div>
          <div className="stats">
            <p className="statinfo">Constitution</p>
            <p>{character.constitution}</p>
          </div>
          <div className="stats">
            <p className="statinfo">Intelligence</p>
            <p>{character.intelligence}</p>
          </div>
          <div className="stats">
            <p className="statinfo">Wisdom</p>
            <p>{character.wisdom}</p>
          </div>
          <div className="stats">
            <p className="statinfo">Charisma</p>
            <p>{character.charisma}</p>
          </div>
          <div className="charPageButtons">
            <Link to={`/Abilities/character/${character._id}`}>
              <button className="abilityButton two">Ability Log</button>
            </Link>
            <button className="updateButton one" onClick={toggleModal}>
              Update Character
            </button>
      ...
      >
        ...
        <Modal.Body>
          <p>this will permanently delete {character.character_name}!</p>
        </Modal.Body>
        <Modal.Footer>
    ...
    <h1>can't find character. try again?</h1>
  )
}
